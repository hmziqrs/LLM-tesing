  ...
  const contributeMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({
        queryKey: orpc.goals.getSummary.queryKey(),
      });
      queryClient.invalidateQueries({
        queryKey: orpc.accounts.getSummary.queryKey(),
      });
    },
  });
      ...
      {goalsSummary && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {goalsSummary.upcomingGoalsCount}
              </div>
              <div className="text-sm text-muted-foreground">
        ...
        <CardContent>
          {goals && goals.length > 0 ? (
                ...
                <div key={goal.id} className="p-4 border rounded-lg">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="text-right">
                      ...
                      <p
                        className={`text-sm ${getDaysRemainingColor(goal.daysRemaining, goal.status)}`}
                      >
            ...
            <div className="text-center py-8">
              ...
              <Button>Create Your First Savings Goal</Button>
            </div>
          )}
        </CardContent>
      </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              <p>
                Contributed{" "}
                <strong>${contributeMutation.data.contributionAmount}</strong>{" "}
                to goal
              </p>
              <p>
                New total:{" "}
                <strong>${contributeMutation.data.newCurrentAmount}</strong>
              </p>
